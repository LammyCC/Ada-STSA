...
writer = SummaryWriter(log_dir='logs/e2e')
...
class TFTrainer(Trainer):
    def __init__(self, model, optimizer, lr_scheduler, max_epoch_num, scaler, model_save_path):
        ...
        self.early_stop = EarlyStop(20, min_is_best=True)
    ...
    def train(self, train_data_loader, eval_data_loader, metrics=('mae', 'rmse', 'mape')):
        ...
        for epoch in range(1, self.max_epoch_num + 1):
            ...
            # record loss
            writer.add_scalar('Loss/train', eval_loss, epoch)
    ...
    def evaluate(self, data_loader, metrics, **kwargs):
        ...
        for x_enc, x_enc_mark, x_dec, x_dec_mark, traj_mx, y in data_loader:
            ...
            pred = self.model(x_enc, x_enc_mark, x_dec, x_dec_mark, traj_mx, **kwargs).detach()
